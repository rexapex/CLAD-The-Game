    ...
    function InputManager(canvas) {
        ...
        this.touchend = function (e) {
            ...
            if (Date.now() - _this.touchStartAt < _this.longTouchDuration) {
                ...
                _this.fireSecondaryMouseDownEvent(e.changedTouches[0].clientX, e.changedTouches[0].clientY);
            }
        };
